"""
layerwise_common.py - common module for the layer-wise experiment with CIFAR10.
...
class CIFAR10Model(torch.nn.Module):
    """
    Very simple model for CIFAR10 classification. 3 layers: 1 convolutional and 2
...
def evaluate_model(model: torch.nn.Module) -> Dict:
    """
    Evaluates the given model on the CIFAR10 test dataset. Downloads the dataset
    ...
    """
    # load and prepare the CIFAR10 test dataset
